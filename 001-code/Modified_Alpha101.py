...
class standardize_101alpha(Support):
    
    # part 1: input data: 
    def __init__():
        
        # 随意给定一些数值 
        self.Closeprice = np.arange(100)
        self.Openprice = np.arange(100)
        self.Highprice = np.arange(100)
        self.Lowprice = np.arange(100)
        self.vwap = np.arange(100) 
        self.adjfactor = np.arange(100) 
        self.Turnover = np.arange(100)
        self.Volume = np.arange(100)
        
        self.Industry=np.arange(100)
        
        self.Universe=df.DataFrame([[1,2,3],[4,5,6]])
...
def modified_alpha4():
    ...
    def modified_alpha3(self):
        ...
        # 改1：volume 本身收到股本规模的影响，此处改为turnover - 换手率（流通股本）
        # 效果不明显
        ##cum_return_rate          0.112566
        ##final_return_rate       0.0223519
        ##beta                     0.467069
        ##alpha                  -0.0441794
        ##sharpe ratio           -0.0690836
        ##information ratio       -0.397706
        ##turnover rate            0.145913
        ##max drawdown             0.402107
            ##drawdown start date  2017-12-25
            ##drawdown end date          None
        ##fitness                -0.0270386    
        # ################################################################################
...
def modified_alpha5():
    ...
    def modified_alpha4(self):
        ...
        #
        # 修改 效果不明显 
        ##cum_return_rate           0.67586
        ##final_return_rate        0.112936
        ##beta                    0.0402409
        ##alpha                   0.0747892
        ##sharpe ratio             0.790998
        ##information ratio       0.0430084
        ##turnover rate            0.177664
        ##max drawdown             0.157968
            ##drawdown start date  2015-07-08
            ##drawdown end date    2015-07-27
        ##fitness                  0.630656    
        # ################################################################################    
...
def modified_alpha7():
    ...
    def modified_alpha7(self):
        ...
        #
        # 效果不明显 略有下降 
        ##cum_return_rate           0.95465
        ##final_return_rate        0.149001
        ##beta                    0.0428601
        ##alpha                    0.110679
        ##sharpe ratio             0.690168
        ##information ratio         0.16408
        ##turnover rate            0.255336
        ##max drawdown             0.235141
            ##drawdown start date  2016-06-14
            ##drawdown end date          None
        ##fitness                  0.527221    
        # ################################################################################  
    ...
    def modified_alpha8(self):
        ...
        # 
        #
        # 改1：用[-15,-5]内的open价格做标准化
        # 改2：sum 改 average
        #
        # 效果不明显 略有下降 
        ##cum_return_rate           1.35144
        ##final_return_rate        0.193862
        ##beta                      0.90453
        ##alpha                   0.0982393
        ##sharpe ratio             0.446191
        ##information ratio        0.330395
        ##turnover rate            0.115639
        ##max drawdown              0.53255
            ##drawdown start date  2017-12-05
            ##drawdown end date          None
        ##fitness                  0.577717    
        # ################################################################################
        ...
        open_return = (np.nanmean(alpha8_openprice[-5:,:],axis=0, keepdims=True)) *  \
                      (np.nanmean(alpha8_return[-5:,:], axis=0, keepdims=True)) /    \
                      (np.nanmean(alpha8_openprice[-15:-5], axis=0, keepdims=True))
        
        open_return10 = (np.nanmean(alpha8_openprice[-15:-10,:],axis=0, keepdims=True)) *  \
                        (np.nanmean(alpha8_return[-15:-10,:],axis=0, keepdims=True)) /     \
                        (np.nanmean(alpha8_openprice[-15:-5], axis=0, keepdims=True))
    ...
    def modified_alpha9(self):
        ...
        ##fitness                  0.212989
        #
        # 改1：将 delta(close) 改为 return
        #
        # 效果不明显 有下降 
        ##cum_return_rate          0.581833
        ##final_return_rate        0.099698
        ##beta                    0.0735758
        ##alpha                   0.0593341
        ##sharpe ratio             0.236837
        ##information ratio     -0.00643117
        ##turnover rate             0.54733
        ##max drawdown             0.392512
            ##drawdown start date  2015-08-26
            ##drawdown end date    2016-08-12
        ##fitness                  0.101081    
        ...
        alpha9_value1 = alpha9_closeadj_delta[-1,:] / alpha9_closeadj[:-1,:]
    ...
    def modified_alpha10(self):
        ...
        # 效果不明显 略有下降 
        #
        ##cum_return_rate          0.327712
        ##final_return_rate       0.0605025
        ##beta                    0.0832424
        ##alpha                   0.0194957
        ##sharpe ratio            0.0960327
        ##information ratio       -0.120632
        ##turnover rate            0.547708
        ##max drawdown             0.393053
            ##drawdown start date  2015-08-28
            ##drawdown end date          None
        ##fitness                 0.0319177    
        # ################################################################################
        ...
        alpha10_value1 = alpha10_closeadj_delta[-1,:] / alpha10_closeadj[:-1]
    ...
    def modified_alpha11(self):
        ...
        ##max drawdown             0.546254
            ...
            ##drawdown end date          None
        ##fitness                  0.378038    
        # 改1: 价差用过去3天的 average vwap 做调整
        # 改2：volume 改为 turnover
        #
        #
        # 效果 不明显 略有下降 
        ##cum_return_rate           1.12673
        ##final_return_rate        0.169267
        ##beta                     0.875487
        ##alpha                   0.0755764
        ##sharpe ratio             0.390136
        ##information ratio        0.250019
        ##turnover rate            0.258746
        ##max drawdown             0.557854
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.315548    
        # ################################################################################
        ...
        alpha11_volume = self.Turnover[di-DELAY-d+1:di-DELAY+1,:] 
        ...
        alpha11 = (self._rank(self._ts_max(alpha11_vwapadj - alpha11_closeadj)/np.nanmean(alpha11_vwapadj, axis=0, keepdims=True)) + \
                   self._rank(self._ts_min(alpha11_vwapadj - alpha11_closeadj)/np.nanmean(alpha11_vwapadj, axis=0, keepdims=True)))  \
                 * (self._rank(self._delta(alpha11_volume)))
    ...
    def modified_alpha12(self):
        ...
        ## fitness                 0.0117029
        #
        # 改1： volume 改 Turnover;
        # 改2:  delata(clsoe) 改为 return 
        #
        # 效果不好  略有下降 
        # 
        ##cum_return_rate          0.119826
        ##final_return_rate       0.0237309
        ##beta                    -0.340616
        ##alpha                   0.0109107
        ##sharpe ratio            -0.054192
        ##information ratio       -0.203236
        ##turnover rate            0.514691
        ##max drawdown             0.447227
            ##drawdown start date  2015-08-17
            ##drawdown end date    2017-12-06
        ##fitness                -0.0116364
        ...
        alpha12_volume = self.Turnover [di-DELAY - 1:di-DELAY + 1 , :]
        
        alpha12_close = self.Closeprice[di-DELAY - 1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY - 1:di-DELAY + 1 , :]
        # 改2 
        alpha12 = -1 * np.sign(self._delta(alpha12_volume)) * np.diff(alpha12_close, axis=0)/alpha12_close[:-1,:]
    ...
    def modified_alpha13(self):
        ...
        # fitness                   0.82706
        # 
        # 改1：把close 都用过去4天的均值做调整
        # 改2：volume 改成 Turnover
        #
        #
        # 效果不好 略有下降 
        ##cum_return_rate           1.79858
        ##final_return_rate        0.237718
        ##beta                      1.01845
        ##alpha                     0.13452
        ##sharpe ratio             0.507813
        ##information ratio        0.437572
        ##turnover rate            0.109516
        ##max drawdown             0.571212
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.748162    
        # ################################################################################
        ...
        alpha13_volume = self.Turnover[di-DELAY - d + 1:di-DELAY + 1 , :]
        # 改1：
        # alpha13_close = self.Closeprice[di-DELAY - d + 1:di-DELAY + 1 , :] 
        alpha13_close = self.Closeprice[di-DELAY - d + 1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY - d + 1:di-DELAY + 1 , :]
        alpha13 = -1 * self._rank(self._covariance(self._rank(alpha13_close/np.nanmean(alpha13_close, axis=0, keepdims=True)) , self._rank(alpha13_volume)))
        alpha13 = alpha13 * -1
    ...
    def modified_alpha14(self):
        ...
        # 改1：将volume改为 Turnover 
        #
        # 略有下降 
        ##cum_return_rate           1.10663
        ##final_return_rate        0.166969
        ##beta                     0.694924
        ##alpha                   0.0852858
        ##sharpe ratio             0.469529
        ##information ratio        0.277117
        ##turnover rate            0.316971
        ##max drawdown             0.380182
            ##drawdown start date  2017-12-05
            ##drawdown end date          None
        ##fitness                  0.340778
        ...
        alpha14_volume = self.Turnover[di-DELAY - d2 + 1:di-DELAY + 1 , :]
    ...
    def modified_alpha15(self):
        ...
        # fitness                  0.717142
        #
        # 改1: volume 换成 turnover
        # 改2：high 改为adjust之后的price
        # 改3：high 用近期的high做标准化，
        #
        # 略有下降 
        #
        ##cum_return_rate           1.52757
        ##final_return_rate        0.211867
        ##beta                      1.03234
        ##alpha                    0.107746
        ##sharpe ratio             0.438195
        ##information ratio        0.351055
        ##turnover rate            0.101627
        ##max drawdown             0.576958
            ##drawdown start date  2015-09-01
            ##drawdown end date          None
        ##fitness                  0.632694    
        # ################################################################################   
        ...
        alpha15_high = self.Highprice[di-DELAY - d + 1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY - d + 1:di-DELAY + 1 , :]
        # 改1
        # alpha15_volume = self.Volume[di-DELAY - d + 1:di-DELAY + 1 , :]
        alpha15_volume = self.Turnover[di-DELAY - d + 1:di-DELAY + 1 , :]
        ...
        average_high = np.nanmean(alpha15_high, axis=0, keepdims=True)
        alpha15_corr1 = self._correlation(self._rank(alpha15_high[0:3 , :]/average_high) , self._rank(alpha15_volume[0:3 , :]/average_high))
        alpha15_corr2 = self._correlation(self._rank(alpha15_high[1:4 , :]/average_high) , self._rank(alpha15_volume[1:4 , :]/average_high))
        alpha15_corr3 = self._correlation(self._rank(alpha15_high[2:5 , :]/average_high) , self._rank(alpha15_volume[2:5 , :]/average_high))
    ...
    def modified_alpha16(self):
        ...
        # ------------------------------------------------
        ##cum_return_rate           2.04502
        ##final_return_rate        0.259557
        ##beta                      1.02823
        ##alpha                    0.155708
        ##sharpe ratio             0.563097
        ##information ratio        0.511787
        ##turnover rate            0.112229
        ##max drawdown             0.574678
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.856341
        ...
        alpha16_close = self.Closeprice[di-DELAY - d + 1:di-DELAY + 1 , :]
    ...
    def modified_alpha17(self):
        ...
        # 改1：将detal(delta(close)) 用close 均价标准化
        #
        # 下降 
        ##cum_return_rate           1.48854
        ##final_return_rate        0.207965
        ##beta                     0.971453
        ##alpha                    0.107892
        ##sharpe ratio             0.455453
        ##information ratio        0.359938
        ##turnover rate            0.338627
        ##max drawdown             0.551494
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.356927
        ...
        alpha17_rank2 = self._rank(np.diff(np.diff(alpha17_closeadj[-3:,:], axis=0), axis=0)/np.nanmean(alpha17_closeadj, axis=0, keepdims=True))
    ...
    def modified_alpha18_improved(self):
        ...
        # fitness                  0.994893
        # 
        # 改1：将价差用当日的平均价格(close+open)/2做标准化
        #
        # 提高 
        ##cum_return_rate           1.44792
        ##final_return_rate        0.203852
        ##beta                      1.00153
        ##alpha                    0.101778
        ##sharpe ratio             0.437531
        ##information ratio        0.343904
        ##turnover rate           0.0865861
        ##max drawdown             0.578687
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.671339    
        #
        ...
        alpha18_1 = (np.nanstd(np.abs((alpha18_close[-d1:] - alpha18_open[-d1:])/(alpha18_close[d2 - 1:d2 , :] + alpha18_open[d2 - 1:d2 , :])*2) , axis=0)).reshape(1 , alpha18_open.shape[1])
        alpha18_2 = (alpha18_close[d2 - 1:d2 , :] - alpha18_open[d2 - 1:d2 , :])/(alpha18_close[d2 - 1:d2 , :] + alpha18_open[d2 - 1:d2 , :])*2    
    ...
    def modified_alpha19_improved(self):
        ...
        # fitness                  0.251104
        #
        # 改1：将close 改成 closeadj 
        # 改2：将 detal(close)用过去250天平均close 做标准化
        #
        # 有提高 
        ##cum_return_rate          0.752094
        ##final_return_rate        0.123244
        ##beta                   -0.0680042
        ##alpha                    0.092295
        ##sharpe ratio             0.316621
        ##information ratio       0.0558083
        ##turnover rate            0.150455
        ##max drawdown             0.308412
            ##drawdown start date  2015-02-25
            ##drawdown end date    2015-05-26
        ##fitness                  0.286562
        ...
        # 改1，改2：
        alpha19 = -1 * np.sign(self._delta(alpha19_adjclose[-8:,:])/np.nanmean(alpha19_adjclose, axis=0, keepdims=True)) * \
                       self._rank(np.nanmean(alpha19_return , axis=0 , keepdims=True))
        alpha = alpha19.reshape(alpha19_adjclose.shape[1] , ) * self.Universe_one.iloc[i , :]
    ...
    def modified_alpha20(self):
        ...
        # fitness                  0.0819591
        #
        # 改1：价差用前一天的 (High+Low)/2 标准化
        #
        #
        # 基本无变化 
        ##cum_return_rate           0.59075
        ##final_return_rate         0.10098
        ##beta                     0.985448
        ##alpha                 -2.3743e-05
        ##sharpe ratio             0.169245
        ##information ratio     -0.00327916
        ##turnover rate            0.457645
        ##max drawdown             0.651957
            ##drawdown start date  2017-12-05
            ##drawdown end date          None
        ##fitness                 0.0795003    
        # ################################################################################  
        ...
        alpha20_price_diff1 = (alpha20_open[1:2 , :] - alpha20_high[0:1 , :])/(alpha20_high[0:1 , :]+alpha20_low[0:1 , :])*2
        alpha20_price_diff2 = (alpha20_open[1:2 , :] - alpha20_close[0:1 , :])/(alpha20_high[0:1 , :]+alpha20_low[0:1 , :])*2
        alpha20_price_diff3 = (alpha20_open[1:2 , :] - alpha20_low[0:1 , :])/(alpha20_high[0:1 , :]+alpha20_low[0:1 , :])*2
        
        alpha20 = -1 * self._rank(alpha20_price_diff1) * self._rank(alpha20_price_diff2) * self._rank(alpha20_price_diff3)
    ...
    def modified_alpha21(self):
        ...
        ##cum_return_rate        -0.0734882
        ##final_return_rate      -0.0156936
        ##beta                    -0.188765
        ##alpha                  -0.0386119
        ##sharpe ratio            -0.320674
        ##information ratio       -0.357311
        ##turnover rate            0.181924
        ##max drawdown             0.280407
            ##drawdown start date  2016-04-19
            ##drawdown end date          None
        ##fitness                -0.0941848
        # 无需标准化改动
        # ################################################################################
    ...
    def modified_alpha22_improved(self):
        # ################################################################################
        ...
        ##max drawdown             0.734976
            ...
            ##drawdown end date          None
        ##fitness                 -0.692341
        # 改1：将价格标准差 中的价格用20日均价调整 
        #
        # 大幅改进 
        #cum_return_rate          0.925026
        #final_return_rate         0.14537
        #beta                   -0.0616662
        #alpha                    0.113999
        #sharpe ratio             0.624685
        #information ratio        0.138187
        #turnover rate              0.3472
        #max drawdown             0.285507
            #drawdown start date  2015-06-17
            #drawdown end date    2015-07-10
        #fitness                  0.404211    
        # ################################################################################  
        ...
        alpha22_close = self.Closeprice[di-DELAY - d3 + 1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY - d3 + 1:di-DELAY + 1 , :]
        ...
        alpha22 = -1 * (corr_ed - corr_st) * self._rank(np.nanstd(alpha22_close/np.nanmean(alpha22_close, axis=0, keepdims=True) , axis=0, keepdims=True))
    ...
    def modified_alpha23_improved(self):
        # ################################################################################
        ...
        # 改1：将delta(high) 用过去20天的 high做调整 
        #
        # 有提高 
        ##cum_return_rate          0.865376
        ##final_return_rate        0.137923
        ##beta                     0.240584
        ##alpha                   0.0864527
        ##sharpe ratio             0.579377
        ##information ratio        0.143742
        ##turnover rate            0.139866
        ##max drawdown             0.238083
            ##drawdown start date  2015-09-15
            ##drawdown end date    2016-02-05
        ##fitness                  0.575338    
        # ################################################################################
        ...
        value = (alpha23_high[d - 1:d , :] - alpha23_high[d - 3 , d - 2]) / np.nanmean(alpha23_high, axis=0, keepdims=True)
        alpha23 = np.where(cond , (-1 * value) ,np.zeros((1,alpha23_high.shape[1])))
    ...
    def modified_alpha24(self):
        ...
        # 改1：分别用过去100天 和 过去3天 close的均价做调整
        #
        # 有提高
        ##cum_return_rate          0.251071
        ##final_return_rate       0.0475153
        ##beta                      0.41685
        ##alpha                  -0.0156764
        ##sharpe ratio            0.0362915
        ##information ratio       -0.157068
        ##turnover rate            0.132163
        ##max drawdown             0.578254
            ##drawdown start date  2017-12-25
            ##drawdown end date          None
        ##fitness                 0.0217604
        #
        ...
        alpha24_value1 = -1 * (alpha24_closeadj[d1+d2-2:d1+d2-1,:] - self._ts_min(alpha24_closeadj[-d2:,:]) )/(np.nanmean(alpha24_closeadj[-d2:,:], axis=0, keepdims=True))
        alpha24_value2 = -1 * (self._delta(alpha24_closeadj[-d3:,:]))/np.nanmean(alpha24_closeadj[-d3:,:], axis=0, keepdims=True)
    ...
    def modified_alpha25(self):
        ...
        # fitness                 0.0553774
        #
        # 改1：价差标准化；乘 vwap 改成 除 vwap 
        # 改2：volume 全部换成turnover
        #
        # 无显著变化  
        ##cum_return_rate           0.38392
        ##final_return_rate       0.0696542
        ##beta                      0.87002
        ##alpha                  -0.0236733
        ##sharpe ratio             0.100361
        ##information ratio       -0.120855
        ##turnover rate             0.28439
        ##max drawdown             0.584965
            ##drawdown start date  2017-12-25
            ##drawdown end date          None
        ##fitness                 0.0496684    
        #
        ...
        alpha25_volume = self.Turnover[di-DELAY - d + 1:di-DELAY + 1 , :]
    ...
    def modified_alpha27(self):
        ...
        alpha27_volume = self.Turnover[di-DELAY - d + 1:di-DELAY + 1 , :]
        ...
        for ii in range(2):
            ...
            corr[ii] = self._correlation(self._rank(alpha27_volume[ii:jj , :]) , \
                                         self._rank(alpha27_vwap[ii:jj , :]/np.nanmean(alpha27_vwap, axis=0, keepdims=True)))
    ...
    def modified_alpha28(self):
        ...
        #
        # cum_return_rate           5.32963
        # final_return_rate        0.465801
        # beta                     0.263629
        # alpha                    0.412799
        # sharpe ratio              1.55991
        # information ratio         1.12487
        # turnover rate            0.335082
        # max drawdown             0.259315
        #   drawdown start date  2016-02-29
        #   drawdown end date    2016-11-11
        # fitness                   1.83919
        # 
        # 改1：将价差用过去5天的close均价标准化 
        # 改2：将价格都改为 adj之后的
        # 
        # 完全失效 
        #
        ##cum_return_rate         -0.248533
        ##final_return_rate      -0.0574943
        ##beta                    -0.107693
        ##alpha                  -0.0858038
        ##sharpe ratio            -0.447059
        ##information ratio       -0.467269
        ##turnover rate            0.205194
        ##max drawdown             0.451751
            ##drawdown start date  2017-04-24
            ##drawdown end date          None
        ##fitness                 -0.236643    
        # ################################################################################
        ...
        alpha28_high = self.Highprice[di-DELAY-d1+1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY-d1+1:di-DELAY + 1 , :]
        alpha28_low_range = self.Lowprice[di-DELAY - d1 + 1:di-DELAY + 1 , :]
        # 改2
        #alpha28_close = self.Closeprice[di-DELAY:di-DELAY + 1 , :]
        alpha28_close = self.Closeprice[di-DELAY-d1+1:di-DELAY + 1 , :] * self.adjfactor[di-DELAY-d1+1:di-DELAY + 1 , :]
        ...
        alpha28 = self._scale(alpha28_corr +  \
                              ((alpha28_high[d1-1:d1,:] + alpha28_low_range[d1-1:d1 , :])/2 - alpha28_close[d1-1:d1]) / \
                               np.nanmean(alpha28_close) )
    ...
    def modified_alpha29_totest(self):
        # ################################################################################
        ...
        # 改1：将 delta(close) 用过去5天的close进行标准化 
        # 改2：两重rank 改为用升序排序
        # 改3：prodct 之后 做一个 标准化
        # ################################################################################
        ...
        for ii in range(d2+d3-1+d4-1+d5-1):
            ...
            alpha29_min_delta[ii] = self._delta(alpha29_closeadj[ii:jj])/np.nanmean(alpha29_closeadj[jj-5:jj,:]) # 是否减1没有影响
        ...
        for ii in range(d3+d4-1+d5-1):
            ...
            alpha29_min_tsmin[ii] = self._ts_min(self._rank(alpha29_min_delta[ii:jj], True))
        ...
        for ii in range(d4+d5-1):
            ...
            alpha29_min_tsrank_sum[ii] = self._rank(self._scale(np.log(np.nanmean(alpha29_min_tsmin[ii:jj], axis=0, keepdims=True) * d3)) , True)
        ...
        for ii in range(d5):
            ...
            alpha29_min_product[ii] = np.power(np.nanprod(alpha29_min_tsrank_sum[ii:jj], axis=0, keepdims=True), d4/(np.sum(np.isnan(alpha29_min_tsrank_sum[ii:jj]), axis=0, keepdims=True)))
    ...
    def modified_alpha30_totest(self):
        ...
        ## cum_return_rate         -0.267304
        ## final_return_rate      -0.0624222
        ## beta                      1.03791
        ## alpha                   -0.166915
        ## sharpe ratio            -0.252584
        ## information ratio       -0.562259
        ## turnover rate            0.170904
        ## max drawdown             0.731181
        ##   drawdown start date  2017-12-25
        ##   drawdown end date          None
        ## fitness                 -0.152651

        # 改1：将volumen 改成 turnover 可能效果不佳
        # ################################################################################
        ...
        alpha30_volume = self.Turnover[di-DELAY-(d2+d3)+1:di-DELAY+1,:]

        alpha30_rank = self._rank(np.sign(alpha30_closeadj[d1-1:d1,:] - alpha30_closeadj[d1-2:d1-1,:]) + \
                                  np.sign(alpha30_closeadj[d1-2:d1-1,:] - alpha30_closeadj[d1-3:d1-2,:]) + \
                                  np.sign(alpha30_closeadj[d1-3:d1-2,:] - alpha30_closeadj[d1-4:d1-3,:]))
    ...
    def modified_alpha31_tovarify(self):
        ...
        # 改1：将 delta(close) 改为过去10天close均值 
        # ################################################################################
        ...
        alpha31_rank2 = self._rank(((-1* np.diff(alpha31_closeadj, n=3, axis=0)[-1,:]).reshape(1,-1))/np.nanmean(alpha31_closeadj, axis=0, keepdims=True))
    ...
    def modified_alpha32_tovarify(self):
        # ################################################################################
        ...
        #
        # 
        # 改1：将 delta close 用过去7天均价做调整 -- 改为收益率
        # ################################################################################   
        ...
        alpha32_1_mean = np.nanmean(alpha32_close[-d1: , :] , axis=0 , keepdims=True)
        alpha32_1 = self._scale((alpha32_1_mean - alpha32_close[d2 - 1:d2 , :])/alpha32_1_mean)
    ...
    def modified_alpha34_totest(self):
        ...
        alpha34_2 = 1 - self._rank((alpha34_closeadj[d2 - 1:d2 , :] - alpha34_closeadj[d2 - 2:d2 - 1 , :])/alpha34_closeadj[d2 - 2:d2 - 1 , :])
    ...
    def modified_alpha35(self):
        ...
        alpha35 = (1-volume_rank) * (1-price_rank) * (1-return_rank)
    ...
    def modified_alpha37_tovarify(self):
        ...
        # 
        # 
        # 改进1：将open-close 改成return 用价格均值调整 
        # ################################################################################
    ...
    def modified_alpha39_totest(self):
        ...
        # 
        # 改1：将rank1 中的 delta(close) 修改成 return
        # ################################################################################
        ...
        rank1 = -1 * self._rank(self._delta(alpha39_closeadj[-8: , :])/alpha39_closeadj[-8:-7,:])
        ...
        # 测试买卖反向
        alpha39 = -1 * alpha39
        alpha = alpha39.reshape(alpha39_volume.shape[1] , ) * self.Universe_one.iloc[i , :]
    ...
    def modified_alpha40_tovarify(self):
        ...
        # fitness                -0.0911778
        #
        # 改1：将 std(high) 改为  std(high/avg(high,10))
        # ################################################################################
        ...
        alpha40_rank = -1 * self._rank(np.nanstd(alpha40_highadj/np.nanmean(alpha40_highadj, axis=0, keepdims=True) , axis=0 , keepdims=True))
    ...
    def modified_alpha41_tovarify(self):
        # ################################################################################
        ...
        alpha41 = (np.sqrt(alpha41_high * alpha41_vwap) - alpha41_vwap)/alpha41_vwap
        alpha = alpha41.reshape(alpha41_high.shape[1] , ) * self.Universe_one.iloc[i , :]

        return alpha 


    def modified_alpha42_tovarify(self):
        ...
        alpha42 = self._rank((alpha42_vwap - alpha42_close)/alpha42_close) / self._rank((alpha42_vwap + alpha42_close)/alpha42_close)
    ...
    def modified_alpha44_tovarify(self):
        ...
        alpha44_volume = self.Turnover[di-DELAY - d + 1:di-DELAY + 1 , :]
    ...
    def modified_alpha45_tba(self):
        ...
        #
        # 改1：将 delay(close) 用 历史时期close做标准化调整 
        # 
        # ################################################################################
    ...
    def modified_alpha48_totest_tba(self):
        ...
        alpha48_closeadj = self.Closeprice[di-DELAY-(d1)+1:di-DELAY+1,:]
        alpha48_return = np.diff(alpha48_closeadj, axis=0) / alpha48_closeadj[:-1]
        Industry = self.Industry[di-DELAY:di-DELAY+1,:]


        alpha48_corr = self._correlation(np.diff(alpha48_closeadj, axis=0)[1:,:], np.diff(alpha48_closeadj, axis=0)[:-1,:])

        alpha48_Ind_corr = self._industry_neutral( alpha48_corr * (np.diff(alpha48_closeadj[-2:,:], axis=0)/alpha48_closeadj[251:252,:]), Industry )
        ...
        alpha = alpha48[0,:] * self.Universe_one.iloc[i,:]
    ...
    def modified_alpha49_totest_tba(self):
        # ################################################################################
    ...
    def modified_alpha52_tba(self):
        ...
        alpha52_lowadj = self.Lowprice[di-DELAY-(d1+d2-1)+1:di-DELAY+1,:] * self.adjfactor[di-DELAY-(d1+d2-1)+1:di-DELAY+1,:]
    ...
    def modified_alpha56_tba(self):
        ...
        # 买卖反向
        alpha56 = -1 * alpha56
        alpha = alpha56.reshape(alpha56_closeadj.shape[1] , ) * self.Universe_one.iloc[i , :]
    ...
    def modified_alpha89_tba(self):
        ...
        d2 = 6 
        d3 = 4 
        alpha89_lowadj = self.Lowprice[di-DELAY-(d1+d2-1+d3-1)+1:di-DELAY+1,:] * self.adjfactor[di-DELAY-(d1+d2-1+d3-1)+1:di-DELAY+1,:]
        alpha89_highadj = self.Highprice[di-DELAY-(d1+d2-1+d3-1)+1:di-DELAY+1,:] * self.adjfactor[di-DELAY-(d1+d2-1+d3-1)+1:di-DELAY+1,:]
        alpha89_volume = self.Volume[di-DELAY-(d0+d1-1+d2-1+d3-1)+1:di-DELAY+1,:]
        ...
        for ii in range(d2+d3-1):
            jj = ii + d1 
            alpha89_rank1_corr[ii] = self._correlation((alpha89_lowadj * w + alpha89_highadj * (1-w))[ii:jj], alpha89_rank1_adv10[ii:jj] ) 

        alpha89_rank1_decay = np.zeros((d3,alpha89_lowadj.shape[1]))
        for ii in range(d3):
            jj = ii + d2 
            alpha89_rank1_decay[ii] = self._decay_linear(alpha89_rank1_corr[ii:jj])

        alpha89_rank1 = self._ts_rank(alpha89_rank1_decay)
        ...
        alpha89_vwapadj = self.vwap[di-DELAY-(d4+d5-1+d6-1)+1:di-DELAY+1,:] * self.adjfactor[di-DELAY-(d4+d5-1+d6-1)+1:di-DELAY+1,:]
        alpha89_industry = self.Industry[di-DELAY-(d4+d5-1+d6-1)+1:di-DELAY+1,:]
        alpha89_Ind_vwapadj = self._industry_neutral(alpha89_vwapadj, alpha89_industry)

        alpha89_rank2_delta = np.zeros((d5+d6-1, alpha89_lowadj.shape[1]))
        for ii in range(d5+d6-1):
            jj = ii + d4 
            alpha89_rank2_delta[ii] = self._delta(alpha89_Ind_vwapadj[ii:jj])

        alpha89_rank2_decay = np.zeros((d6, alpha89_lowadj.shape[1]))
        for ii in range(d6):
            jj = ii + d5 
            alpha89_rank2_decay[ii] = self._decay_linear(alpha89_rank2_delta[ii:jj])

        alpha89_rank2 = self._ts_rank(alpha89_rank2_decay)
        alpha89 = alpha89_rank1 - alpha89_rank2 
        alpha = alpha89[0,:] * self.Universe_one.iloc[i,:]
    ...
    def modified_alpha98_tba(self):
        
        # ################################################################################    
        # Alpha#98: (rank(decay_linear(correlation(vwap, sum(adv5, 26.4719), 4.58418), 7.18088)) - rank(decay_linear(Ts_Rank(Ts_ArgMin(correlation(rank(open), rank(adv15), 20.8187), 8.62571), 6.95668), 8.07206)))
        # Alpha#98: (rank(decay_linear(correlation(vwap, sum(adv5, 26), 5), 7)) - rank(decay_linear(Ts_Rank(Ts_ArgMin(correlation(rank(open), rank(adv15), 21), 9), 7),8)))
    ...
    def modified_alpha99_tba(self):
        ...
        # 回测结果（买卖反向后）
        ##cum_return_rate           1.34226
        ##final_return_rate        0.192894
        ##beta                      1.00985
        ##alpha                    0.090268
        ##sharpe ratio             0.400111
        ##information ratio        0.297416
        ##turnover rate            0.152288
        ##max drawdown             0.592334
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.450306
        # 
        # 改1：将 volume 改为turnover 
        # ################################################################################
        ...
        alpha99_volume = self.Turnover[di-DELAY-(d0+d1-1+d2-1)+1:di-DELAY+1,:]
    ...
    def modified_alpha100(self):
        ...
        # 回测结果
        ##cum_return_rate          0.956497
        ##final_return_rate        0.149225
        ##beta                   -0.0221713
        ##alpha                    0.115229
        ##sharpe ratio             0.612265
        ##information ratio        0.151378
        ##turnover rate            0.090535
        ##max drawdown             0.183018
            ##drawdown start date  2014-07-22
            ##drawdown end date    2014-12-24
        ##fitness                  0.786055
        # ------------------------------------------
        # 改1：把 volume 改为 turnover
        # 略有改进
        ## cum_return_rate           1.11851
        ## final_return_rate        0.168331
        ## beta                   -0.0685493
        ## alpha                    0.137418
        ## sharpe ratio             0.574415
        ## information ratio         0.18998
        ## turnover rate           0.0761082
        ## max drawdown             0.274784
        ##   drawdown start date  2015-09-15
        ##   drawdown end date    2015-12-11
        ## fitness                  0.854263
        # ################################################################################
        ...
        alpha100_volume = self.Turnover[di-DELAY-(d0+d1-1)+1:di-DELAY+1]
    ...
    def modified_alpha101(self):
        ...
        # 回测结果
        # 近期一致走弱 
        ##cum_return_rate           1.84642
        ##final_return_rate        0.242074
        ##beta                     0.033686
        ##alpha                    0.204363
        ##sharpe ratio             0.688827
        ##information ratio        0.366465
        ##turnover rate            0.517232
        ##max drawdown             0.289479
            ##drawdown start date  2016-02-29
            ##drawdown end date    2016-06-15
        ##fitness                  0.471239
        # 无需标准化修改
        # ################################################################################
