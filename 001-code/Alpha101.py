...
class standardize_101alpha(Support):
    ...
    def compute_alpha9():
        ...
        #
        # 含义： 过去5天内 收盘价变动的最小值 > 
        0 --> 买入当日收盘价大幅上升的股票；卖出当日收盘价大幅下跌的股票
    ...
    def compute_alpha32():
        ...
        ##cum_return_rate           1.90253
        ##final_return_rate        0.247109
        ##beta                     0.891703
        ##alpha                     0.15234
        ##sharpe ratio              0.61455
        ##information ratio        0.542859
        ##turnover rate          0.00158689
        ##max drawdown             0.499921
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                   7.66881
        # 
    ...
    def compute_alpha35_additional_test():
        ...
        # cum_return_rate            1.2653
        # final_return_rate        0.184663
        # beta                      1.05264
        # alpha                   0.0791919
        # sharpe ratio             0.365711
        # information ratio        0.261588
        # turnover rate            0.338168
        # max drawdown             0.679145
        #   drawdown start date  2017-12-25
        #   drawdown end date          None
        # fitness                  0.270248
        # 
        ...
        # 1-volume_rank
        #------------------
        #cum_return_rate          0.798325
        #final_return_rate        0.129323
        #beta                      1.03392
        #alpha                    0.025096
        #sharpe ratio             0.230564
        #information ratio       0.0858726
        #turnover rate            0.174657
        #max drawdown             0.649254
            #drawdown start date  2017-12-25
            #drawdown end date          None
        #fitness                  0.198398        
        #------------------
        # 2-price_rank
        #------------------ 
        #cum_return_rate           1.89966
        #final_return_rate        0.246854
        #beta                     0.830846
        #alpha                    0.156131
        #sharpe ratio             0.646349
        #information ratio        0.559033
        #turnover rate            0.104643
        #max drawdown             0.458367
            #drawdown start date  2015-07-08
            #drawdown end date          None
        #fitness                  0.992732        
        #------------------
        # 3-return_rank
        #------------------      
        #cum_return_rate            1.8757
        #final_return_rate        0.244711
        #beta                     0.872527
        #alpha                    0.151217
        #sharpe ratio             0.622238
        #information ratio        0.546297
        #turnover rate            0.201943
        #max drawdown             0.493009
            #drawdown start date  2017-12-25
            #drawdown end date          None
        #fitness                  0.684966    
        #------------------
        # 4-price_rank * return_rank
        #------------------         
        #cum_return_rate           2.30029
        #final_return_rate        0.280746
        #beta                     0.783767
        #alpha                    0.193155
        #sharpe ratio             0.789696
        #information ratio        0.715964
        #turnover rate            0.227231
        #max drawdown             0.445141
            #drawdown start date  2015-07-08
            #drawdown end date          None
        #fitness                  0.877775        
        # ################################################################################
    ...
    def compute_alpha36_additional_test():
        ...
        # 
        # 测试1.单独测试每一个因子，并把rank5 改成 相除 
        # 
        # ----------------------------------------
        # rank1:
        # ---------
        ## cum_return_rate           1.47816
        ## final_return_rate        0.206919
        ## beta                     0.978404
        ## alpha                    0.106384
        ## sharpe ratio             0.450654
        ## information ratio        0.355438
        ## turnover rate           0.0715489
        ## max drawdown             0.547059
        ##   drawdown start date  2015-09-15
        ##   drawdown end date          None
        ## fitness                  0.766376
        # ----------------------------------------
        # rank2:
        # ---------
        ##cum_return_rate          0.646635
        ##final_return_rate        0.108886
        ##beta                      0.87577
        ##alpha                   0.0151762
        ##sharpe ratio             0.214555
        ##information ratio        0.025791
        ##turnover rate             0.26071
        ##max drawdown              0.56575
          ##drawdown start date  2017-12-25
          ##drawdown end date          None
        ##fitness                  0.138658
        # ----------------------------------------
        # rank3:
        # ---------  
        ##cum_return_rate           1.94928
        ##final_return_rate        0.251245
        ##beta                     0.955079
        ##alpha                    0.152261
        ##sharpe ratio             0.579754
        ##information ratio        0.515746
        ##turnover rate            0.216472
        ##max drawdown             0.534977
            ##drawdown start date  2015-09-15
            ##drawdown end date          None
        ##fitness                  0.624585      
        
        # 第三个因子效果最好，但都是在2017年下降  
        # ################################################################################
    ...
    def compute_alpha38_additional_test():
    ...
    def compute_alpha39():
        ...
        # -1 * rank1
        # --------------
        #cum_return_rate           2.52099
        #final_return_rate        0.298043
        #beta                     0.905338
        #alpha                    0.202367
        #sharpe ratio             0.739376
        #information ratio        0.704964
        #turnover rate           0.0890718
        #max drawdown             0.522838
            #drawdown start date  2015-09-01
            #drawdown end date          None
        #fitness                   1.35249    
        # --------------
        # rank2
        # --------------    
        #cum_return_rate           1.07727
        #final_return_rate         0.16358
        #beta                      1.01854
        #alpha                   0.0603762
        #sharpe ratio             0.328843
        #information ratio        0.206075
        #turnover rate           0.0161076
        #max drawdown             0.578544
            #drawdown start date  2017-12-25
            #drawdown end date          None
        #fitness                   1.04794     
        # --------------
        # rank3 
        # -------------- 
        #cum_return_rate           2.16281
        #final_return_rate        0.269502
        #beta                     0.892137
        #alpha                    0.174704
        #sharpe ratio             0.682389
        #information ratio        0.631173
        #turnover rate          0.00727379
        #max drawdown             0.482288
            #drawdown start date  2015-09-01
            #drawdown end date          None
        #fitness                   4.15368        
        #
        #
        # rank1 和 rank3 都还可以，但是 2017年依然下跌
        # ################################################################################
    ...
    def compute_alpha83():
        ...
        ##cum_return_rate           5.26078
        ##final_return_rate        0.462483
        ##beta                    0.0954088
        ##alpha                    0.420667
        ##sharpe ratio              1.26002
        ##information ratio        0.891266
        ##turnover rate            0.523675
        ##max drawdown             0.259518
          ##drawdown start date  2015-08-26
          ##drawdown end date    2015-09-02
        ##fitness                   1.18412
    ...
    def compute_alpha85():
        ...
        # 回测结果
        ##cum_return_rate           1.11986
        ##final_return_rate        0.168485
        ##beta                      1.02181
        ##alpha                   0.0650633
        ##sharpe ratio             0.336063
        ##information ratio        0.217087
        ##turnover rate           0.0521332
        ##max drawdown             0.585742
            ##drawdown start date  2017-12-25
            ##drawdown end date          None
        ##fitness                  0.604148
        # ################################################################################
    ...
    def compute_alpha89():
        ...
        # 回测结果
        ##cum_return_rate          0.946737
        ##final_return_rate        0.148035
        ##beta                     0.630196
        ##alpha                   0.0706558
        ##sharpe ratio              0.43751
        ##information ratio        0.204846
        ##turnover rate            0.259958
        ##max drawdown             0.398274
            ##drawdown start date  2015-09-01
            ##drawdown end date          None
        ##fitness                  0.330156
        # ################################################################################
    ...
    def compute_alpha90():
        ...
        # 回测结果
        ##cum_return_rate           1.10425
        ##final_return_rate        0.166696
        ##beta                      1.01289
        ##alpha                   0.0638676
        ##sharpe ratio             0.334733
        ##information ratio        0.213418
        ##turnover rate           0.0656608
        ##max drawdown             0.618101
          ##drawdown start date  2017-12-25
          ##drawdown end date          None
        ##fitness                  0.533345
        # ################################################################################
    ...
    def compute_alpha91():
        ...
        # 回测结果
        ##cum_return_rate            1.0615
        ##final_return_rate        0.161744
        ##beta                     0.974528
        ##alpha                   0.0614663
        ##sharpe ratio              0.33235
        ##information ratio        0.202342
        ##turnover rate            0.093149
        ##max drawdown             0.571907
            ##drawdown start date  2017-12-05
            ##drawdown end date          None
        ##fitness                  0.437946
        # ################################################################################
    ...
    def compute_alpha93():
        ...
        # 回测结果
        ##cum_return_rate           1.91165
        ##final_return_rate         0.24792
        ##beta                      0.91769
        ##alpha                    0.151423
        ##sharpe ratio             0.590523
        ##information ratio        0.518657
        ##turnover rate            0.106227
        ##max drawdown             0.494752
            ##drawdown start date  2015-07-08
            ##drawdown end date          None
        ##fitness                  0.902144
        # ################################################################################
    ...
    def compute_alpha94():
        ...
        # 回测结果 (反向之后)
        ##cum_return_rate           1.66486
        ##final_return_rate        0.225223
        ##beta                     0.860073
        ##alpha                    0.132557
        ##sharpe ratio             0.575749
        ##information ratio         0.48228
        ##turnover rate           0.0696821
        ##max drawdown             0.478175
            ##drawdown start date  2017-12-05
            ##drawdown end date          None
        ##fitness                   1.03509
    ...
    def compute_alpha95():
        ...
        # 回测结果
        ##cum_return_rate          0.375477
        ##final_return_rate       0.0682986
        ##beta                     0.962309
        ##alpha                  -0.0311662
        ##sharpe ratio            0.0840813
        ##information ratio        -0.10822
        ##turnover rate            0.198074
        ##max drawdown             0.671957
            ##drawdown start date  2017-12-25
            ##drawdown end date          None
        ##fitness                 0.0493732
    ...
    def compute_alpha97():
        ...
        for ii in range(d5+d6-1+d7-1+d8-1):
            jj = ii + d4
            alpha97_rank2_corr_tsrank2[ii] = self._ts_rank(alpha97_rank2_corr_adv60[ii:jj])
